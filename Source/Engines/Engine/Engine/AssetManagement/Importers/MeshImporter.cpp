...
#ifdef _DEBUG
void MeshImporter::LoadAllMeshes(std::vector<MeshData>& aOutAssetList)
{
...
void MeshImporter::Load_FBX(const char* aPath, std::vector<MeshData>& aOutAssetList)
{
...
void MeshImporter::Load_OBJ(const char* aPath, std::vector<MeshData>& aOutAssetList)
{

}

void MeshImporter::ConvertFromTGAMesh(const TGA::FBX::Mesh& aMesh, std::vector<MeshData>& aOutAssetList)
{
...
std::vector<BinaryExporter::MeshIndex>& MeshImporter::GetExportedAssets() { return myLoadedMeshes; }