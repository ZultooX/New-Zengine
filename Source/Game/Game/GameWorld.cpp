...
{
	{
		...
		rend->SetTexture(ZENGINE_TEXTURES_PATH"TEX_Anubis_Reaper_a.tga", TextureSlot::Albedo);
		rend->SetTexture(ZENGINE_TEXTURES_PATH"TEX_Anubis_Reaper_n.tga", TextureSlot::Normal);
